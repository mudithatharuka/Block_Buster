...
<body>
	...
	<div class="Upper">
		<h1>Hello <?php echo $data['name']; ?> ! <h3> -   your profile</h3></h1>
	...
	<div class="Content">
		...
		<div class="Cont-L">
			<img src="Post_images/Users/<?php echo $_SESSION['user_id']; ?>/<?php echo $data['p_photo']; ?>" alt="profile image">	
		</div><!--Cont-L-->
		...
		<div class="Cont-R">
			...
			<div class="Overview">
				...
				<br><h4>YOUR REVIWS ON M0VIES</h4><br><br>
			...
			if($result_review && $num_reviews > 0){
				while ($data_review = mysqli_fetch_assoc($result_review)) {
					...
					<div class="Single-review">
						<div class="About">
							<img src="Post_images/Movies/<?php echo $data_movie['movie_id']; ?>/<?php echo $data_movie['main_img']; ?>" alt="Movie image">
							<a href="singlemovie.php?movie_id=<?php echo $data_movie['movie_id'] ?>"><h2><?php echo $data_movie['m_name']; ?></h2></a>
						...
						<div class="Review">
							...
							<a href="delete-user-review.php?review_id=<?php echo $data_review['review_id'] ?>" onclick="return confirm('Are you sure you want to delete this review?');">
								<button style="background-color: red;color:#fff; font-weight: bold;padding: 5px 10px;border: 1px solid red;border-radius: 15px;">DELETE THIS REVIEW
								</button>
							</a></p>
			...
			?>
				...
				<br><h4>YOUR REVIEWS ON TV SERIES</h4><br><br>
			...
			if($result_review && $num_reviews > 0){
				while ($data_review = mysqli_fetch_assoc($result_review)) {
					...
					<div class="Single-review">
						<div class="About">
							<img src="Post_images/TVSeries/<?php echo $data_tvseries['series_id']; ?>/<?php echo $data_tvseries['main_img']; ?>" alt="TVSeries image">
							<a href="singletvseries.php?series_id=<?php echo $data_tvseries['series_id'] ?>"><h2><?php echo $data_tvseries['s_name']; ?></h2></a>
							<h3><?php echo $data_review['r_name']; ?></h3>
							<h5><?php
						...
						<div class="Review">
							<p><?php echo $data_review['description']; ?><br><br>
							<a href="delete-user-tsrreview.php?review_id=<?php echo $data_review['review_id'] ?>" onclick="return confirm('Are you sure you want to delete this review?');">
								<button style="background-color: red;color:#fff; font-weight: bold;padding: 5px 10px;border: 1px solid red;border-radius: 15px;">DELETE THIS REVIEW
								</button>
							</a></p>
						</div><!--Review-->
