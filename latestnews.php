...
<body>
	...
	<div class="Content">
		...
		<div class="Cont-L">
			<img src="Post_images/Latestnews/<?php echo $_GET['ltn_id']; ?>/<?php echo $data['main_img']; ?>" alt="latestnews image">	
		</div><!--Cont-L-->
		...
		<div class="Cont-R">
			...
			<div class="Overview">
				...
				<h4>FEW PHOTOS</h4>
				<img src="Post_images/Latestnews/<?php echo $_GET['ltn_id']; ?>/<?php echo $data['im_1']; ?>" alt="latestnews image1">
				<img src="Post_images/Latestnews/<?php echo $_GET['ltn_id']; ?>/<?php echo $data['im_2']; ?>" alt="latestnews image1">
				<img src="Post_images/Latestnews/<?php echo $_GET['ltn_id']; ?>/<?php echo $data['im_3']; ?>" alt="latestnews image1">
				<img src="Post_images/Latestnews/<?php echo $_GET['ltn_id']; ?>/<?php echo $data['im_4']; ?>" alt="latestnews image1">
