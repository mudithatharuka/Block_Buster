	...
	<div class="Content">
		...
		<div class="Cont-R">
			...
			<div class="Overview">
				...
				<h4>FEW PHOTOS</h4>
				<img src="Post_images/TVSeries/<?php echo $_GET['series_id']; ?>/<?php echo $data['im_1']; ?>" alt="series image1">
				<img src="Post_images/TVSeries/<?php echo $_GET['series_id']; ?>/<?php echo $data['im_5']; ?>" alt="series image2">
				<img src="Post_images/TVSeries/<?php echo $_GET['series_id']; ?>/<?php echo $data['im_8']; ?>" alt="series image3">
				<img src="Post_images/TVSeries/<?php echo $_GET['series_id']; ?>/<?php echo $data['im_11']; ?>" alt="series image4">
			</div><!--Overview-->
			...
			<div class="Summery">
				...
				<h6><?php echo $data['seasons']; ?></h6>
				<h5>Relese date:</h5>
				<h6><?php echo $data['relese_date']; ?></h6>
				<h5>Run time:</h5>
				<h6><?php echo $data['run_time']; ?></h6>
				<h5>Rating:</h5>
				<h6><?php echo $data['ratings']; ?></h6>
