	...
	<div class="Content">
		...
		<div class="Cont-R">
			...
			<div class="Above">
				...
				<a href="add-tsrreview.php?series_id=<?php echo $_GET['series_id'] ?>"><input type="submit" name="write-review" value="REVIEW"></a>
			</div><!--Above-->
			...
			<div class="Single-review">
				<div class="About">
					<img src="Post_images/Users/<?php echo $data_user['user_id']; ?>/<?php echo $data_user['p_photo']; ?>" alt="Profile image">
