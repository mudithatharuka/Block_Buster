...
<head>
	<title></title>
	<link rel="stylesheet" type="text/css" href="inc/css/hedertvseries.css">
</head>
<body>
		...
		<div class="Background">
			...
			<div class="Header">
				...
				<div class="NavBar Body clearfix">
					...
					<?php 
						...
						?>
							<div class="List3">
								<ul>
									<li><a href="profile.php"><button name="profile" id="profile"><i class="fas fa-user-circle 3x"></i></button></a></li>
				...
				<form action="index.php" method="get">
					...
					<input type="text" class="category" placeholder="Search for a movie, TV show that you want" name="search" required="">
