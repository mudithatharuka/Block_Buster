...
<body>
	...
	<header>
		...
		<div class="Sitename"><i class="fas fa-bars"></i> BLOCK BUSTER</div><!--Sitename-->

		<div class="Loggedin">Welcome Admin <?php echo $_SESSION['name'];?>! <a href="adminlogout.php"><button>Log Out</button></a></div>
	</header>
	...
	<div class="Choosehead">
			<ul>
				...
				<li><a href="admins.php?admin_id=<?php echo $_SESSION['admin_id'] ?>"><button class="Admins" >Admins</button></a></li>
				<?php } ?>
			</ul>
		</div><!-- Choosehead -->
