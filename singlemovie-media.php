    ...
    <div class="Content">
        ...
        <div class="Cont-R">
            ...
            <div class="Photos">
                ...
                <img src="Post_images/Movies/<?php echo $_GET['movie_id']; ?>/<?php echo $data['im_1']; ?>"
                    alt="movie image">
                <img src="Post_images/Movies/<?php echo $_GET['movie_id']; ?>/<?php echo $data['im_2']; ?>"
                    alt="movie image">
                <img src="Post_images/Movies/<?php echo $_GET['movie_id']; ?>/<?php echo $data['im_3']; ?>"
                    alt="movie image">
                <img src="Post_images/Movies/<?php echo $_GET['movie_id']; ?>/<?php echo $data['im_4']; ?>"
                    alt="movie image">
                <img src="Post_images/Movies/<?php echo $_GET['movie_id']; ?>/<?php echo $data['im_5']; ?>"
                    alt="movie image">
                <img src="Post_images/Movies/<?php echo $_GET['movie_id']; ?>/<?php echo $data['im_6']; ?>"
                    alt="movie image">
                <img src="Post_images/Movies/<?php echo $_GET['movie_id']; ?>/<?php echo $data['im_7']; ?>"
                    alt="movie image">
                <img src="Post_images/Movies/<?php echo $_GET['movie_id']; ?>/<?php echo $data['im_8']; ?>"
                    alt="movie image">
                <img src="Post_images/Movies/<?php echo $_GET['movie_id']; ?>/<?php echo $data['im_9']; ?>"
                    alt="movie image">
                <img src="Post_images/Movies/<?php echo $_GET['movie_id']; ?>/<?php echo $data['im_10']; ?>"
                    alt="movie image">
                <img src="Post_images/Movies/<?php echo $_GET['movie_id']; ?>/<?php echo $data['im_11']; ?>"
                    alt="movie image">
                <img src="Post_images/Movies/<?php echo $_GET['movie_id']; ?>/<?php echo $data['im_12']; ?>"
                    alt="movie image">
