...
<body>
	...
	<div class="Content">
		...
		<a href="celebrity.php"> <-Back to list</a>
		...
		<form method="post" action="modify-celebrity.php" enctype="multipart/form-data">
			...
			<div class="balance"></div>
				...
				<input type="text" name="years" placeholder=" Add his years of this industry" <?php echo 'value="' .$years. '"'; ?>>
			</p>
			...
			<p>
				...
				<input type="number" name="ratings" placeholder=" Add ratings/10" <?php echo 'value="' .$ratings. '"'; ?>>
			</p>
			...
			<p>
				...
				<input type="number" name="number_of_films" placeholder=" Add number of films participated" <?php echo 'value="' .$number_of_films. '"'; ?>>
			</p>
			...
			<p>
				...
				<input type="number" name="number_of_tvseries" placeholder=" Add number of tvseries participated" <?php echo 'value="' .$number_of_tvseries. '"'; ?>>
			</p>
			<div class="balance"></div>
