	...
	<div class="Wrapper">
		...
		?>
				...
				<div class="Slides">
					...
					<a href="<?php echo("singlemovie.php?movie_id={$row['movie_id']}") ?>">
						<div>
							<img src="Post_images/Movies/<?php echo $row['movie_id']; ?>/<?php echo $row['main_img']; ?>" alt="img1">
		...
		<div class="Content">
			<div class="In-theater">
				<div class="topic"><h2>IN THEATER <i class="fas fa-video"></i></h2><a href="movielisting.php?in_theater"><h5>VIEW ALL<i class="fas fa-angle-right"></i></h5></a></div>
				<div class="Ancours">
...
<!-- 					<div class="Slide2 first2">
						...
						if($result && mysqli_num_rows($result) > 0){
							...
							while($data = mysqli_fetch_assoc($result)){
								...
								if($i < 4){
									...
									<a href="celebrities.php?cbr_id=<?php echo($data['cbr_id']) ?>"><div>
										<img src="Post_images/Celebrities/<?php echo $data['cbr_id']; ?>/<?php echo $data['main_img']; ?>">
			...
			<br><br>
			<div class="Ontv">
				<div class="topic"><h2>ON TV <i class="fas fa-tv 2x"></i></h2><a href="tvserieslisting.php"><h5>VIEW ALL<i class="fas fa-angle-right"></i></h5></a></div>
				<div class="Ancours">
				...
				<div class="Slides3">
					...
					<a href="<?php echo("singletvseries.php?series_id={$row['series_id']}") ?>">
						<div>
							<img src="Post_images/TVSeries/<?php echo $row['series_id']; ?>/<?php echo $row['main_img']; ?>" alt="img1">
							<?php $b_color = define_b_color($row['main_category']); ?>
							<h6 style="background-color: <?php echo $b_color; ?>;"><?php echo $row['main_category']; ?></h6>
							<h3><i class="fas fa-star"></i><?php echo $row['ratings']."/10"; ?></h3>
 ...
 -->
		...
		<div class="Content2">
			...
			?>
			<div class="iframe1"><iframe width="65%" height="432px" <?php echo $data1['off_t_e_link']; ?>></iframe></div>


			<div class="iframe2" style="display: none;"><iframe width="65%" height="432px" <?php echo $data2['off_t_e_link']; ?>></iframe></div>

			<div class="iframe3" style="display: none;"><iframe width="65%" height="432px" <?php echo $data3['off_t_e_link']; ?>></iframe></div>

			<div class="iframe4" style="display: none;"><iframe width="65%" height="432px" <?php echo $data4['off_t_e_link']; ?>></iframe></div>
				...
				<div class="part1 clearfix point">
					<div class="part">
						<?php if(isset($data1['movie_id'])){?>
							<img src="Post_images/Movies/<?php echo $data1['movie_id']; ?>/<?php echo $data1['main_img']; ?>" alt="tariler image">
							<h4><?php echo $data1['m_name']; ?></h4>
							<h5><?php echo $data1['u_date']; ?></h5><?php	
						} ?>

					</div><!--part-->
				</div><!-- part1 --><div class="balance"></div>


				<div class="part2 clearfix point">
					<div class="part">
						<?php if(isset($data2['movie_id'])){?>
							<img src="Post_images/Movies/<?php echo $data2['movie_id']; ?>/<?php echo $data2['main_img']; ?>" alt="tariler image">
							<h4><?php echo $data2['m_name']; ?></h4>
							<h5><?php echo $data2['u_date']; ?></h5><?php	
						} ?>
					</div><!--part-->
				</div><!-- part2 --><div class="balance"></div>

				
				<div class="part3 clearfix point">
					<div class="part">
						<?php if(isset($data3['movie_id'])){?>
							<img src="Post_images/Movies/<?php echo $data3['movie_id']; ?>/<?php echo $data3['main_img']; ?>" alt="tariler image">
							<h4><?php echo $data3['m_name']; ?></h4>
							<h5><?php echo $data3['u_date']; ?></h5><?php	
						} ?>
					</div><!--part-->
				</div><!-- part3 --><div class="balance"></div>
				

				<div class="part4 clearfix point">
					<div class="part">
						<?php if(isset($data4['movie_id'])){?>
							<img src="Post_images/Movies/<?php echo $data4['movie_id']; ?>/<?php echo $data4['main_img']; ?>" alt="tariler image">
							<h4><?php echo $data4['m_name']; ?></h4>
							<h5><?php echo $data4['u_date']; ?></h5><?php	
						} ?>
					</div><!--part-->
				</div><!-- part4 --><div class="balance"></div>
				...
				<div class="LatestNews">
					...
					<?php
						if(isset($news1['ltn_id'])){
							?><a href="<?php echo("latestnews.php?ltn_id={$news1['ltn_id']}"); ?>"><img src="Post_images/Latestnews/<?php echo($news1['ltn_id']); ?>/<?php echo($news1['main_img']); ?>">
							<h4><?php echo($news1['n_title']); ?></h4><br>
							<h6><?php echo($news1['u_date_time']); ?></h6><br>
							<p><?php echo(substr($news1['n_descrip'], 0, 300)); ?> ...</p></a><br><?php
						}
					?>
				...
				<div class="More">
					...
					<div class="More-L">
						...
						if(isset($news2['ltn_id'])){
							?><a href="<?php echo("latestnews.php?ltn_id={$news2['ltn_id']}"); ?>" class="title"><?php echo($news2['n_title']); ?></a>
						...
						if(isset($news3['ltn_id'])){
							?><a href="<?php echo("latestnews.php?ltn_id={$news3['ltn_id']}"); ?>" class="title"><?php echo($news3['n_title']); ?></a>
					...
					<div class="More-R">
						...
						if(isset($news4['ltn_id'])){
							?><a href="<?php echo("latestnews.php?ltn_id={$news4['ltn_id']}"); ?>" class="title"><?php echo($news4['n_title']); ?></a>
							<h6><?php echo($news4['u_date_time']); ?></h6><?php
						}?>
						
						<?php
						if(isset($news5['ltn_id'])){
							?><a href="<?php echo("latestnews.php?ltn_id={$news5['ltn_id']}"); ?>" class="title"><?php echo($news5['n_title']); ?></a>
