		...
		<div class="Cont-R">
			...
			<a href="<?php echo("singletvseries.php?series_id={$row['series_id']}") ?>">
				...
				<div class="Related-movies">
					<img src="Post_images/TVSeries/<?php echo $row['series_id']; ?>/<?php echo $row['main_img']; ?>" alt="series image">
					<h4><?php echo $row['s_name']; ?></h4>
					<h4><i class="fas fa-star"></i><?php echo $row['ratings']; ?>/10</h4>
					<div class="descrip">
						<p><?php echo $row['small_descrip']; ?></p>
					</div><!--descrip-->
					<p>Run time: <?php echo $row['run_time']; ?>' ...... Relese: 1 <?php echo $row['relese_date']; ?></p>
					<h5>Director:</h5><h6><?php echo $row['s_director']; ?></h6>
					<h5>Stars:</h5><h6><?php echo $row['stars']; ?></h6>
					<div class="balance">
