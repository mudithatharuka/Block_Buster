...
?></h4>
    ...
    <div class="Content">
        ...
        <div class="Cont-L">
            <img src="Post_images/Celebrities/<?php echo $_GET['cbr_id']; ?>/<?php echo $data['main_img']; ?>"
                alt="celebrity image">
        </div>
        <!--Cont-L-->
        ...
        <div class="Cont-R">
            ...
            <div class="Overview">
                ...
                <h4>FEW PHOTOS</h4>
                <img src="Post_images/Celebrities/<?php echo $_GET['cbr_id']; ?>/<?php echo $data['im_1']; ?>"
                    alt="celebrity image1">
                <img src="Post_images/Celebrities/<?php echo $_GET['cbr_id']; ?>/<?php echo $data['im_2']; ?>"
                    alt="celebrity image1">
                <img src="Post_images/Celebrities/<?php echo $_GET['cbr_id']; ?>/<?php echo $data['im_3']; ?>"
                    alt="celebrity image1">
                <img src="Post_images/Celebrities/<?php echo $_GET['cbr_id']; ?>/<?php echo $data['im_4']; ?>"
                    alt="celebrity image1">
